          ...
          <div class="card-body" style="border: 1px solid #b1bfeb; box-shadow: 0 2px 10px #b1bfeb;">
            <div class="blockSize">
              ...
              <div *ngIf="elementObjetfinancement">
                ...
                <!-- Add remaining fields similarly, binding them to selectedObjet properties -->
                <!-- The remaining fields are not shown for brevity -->
              </div>
            </div>
          </div>
        </div>
...
@Component({
  ...
  styleUrls: ['./fil-ariane.component.css']
})
